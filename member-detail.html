...
<head>
    ...
    <link href="https://getbootstrap.com/headers.css" rel="stylesheet">
    ...
    <div class="container bg-dark">
        ...
        <div class="row p-3">
            <div class="d-flex justify-content-center">
                <div class="logo">
                    <h2 class="fw-bolder text-light">Admin SaCode</h2>
                </div>
            </div>
        </div>
            ...
            <div class="col-9">
                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        ...
                        <div>
                            <a href="member.html" class="btn btn-dark bg-light text-dark">Kembali</a>
                        </div>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <form action="member.html">
                                    ...
                                    <img src="speaker/sacodesweekend-nick-2.png" alt="speaker"
                                        class="img img-thumbnail mb-2" width="200">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea id="about" cols="30" rows="5" class="form-control"
                                            disabled></textarea>
                                    </div>
